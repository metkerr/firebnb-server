...
var data = [
  ...
  //       isPopular: false,
  //       description:
  //         "Beautiful home offering 4 bedrooms, great living room and kitchen with all the amenities. The house is sunny and has a decking for enjoying the sun. The house is close to transport, the beach and Eastbourne village. The house also has gas central heating, heatpump plus a wood fireplace.",
  //       unit: "night",
  //       imageId: [
  //         // done
  ...
  //       accountNumber: "254854877475",
  //       name: "Firebnb co.",
  //       imageUrl: "images/bnz.jpg",
  //     },
  //     {
  //       _id: mongoose.Types.ObjectId("5e96cbe292b97300fc903323"),
  //       bankName: "ASB Bank",
  //       accountNumber: "6548874858",
  //       name: "Firebnb co.",
  //       imageUrl: "images/asb.jpg",
  //     },
  //   ],
  // },
  // {
